...
&nbsp;&nbsp;
토픽(Topic) 구성은 다음과 같이 네 단계로 확인하였다.
<br/>&nbsp;&nbsp; 우선 Publisher와 Subscriber를 제외한 초기 토픽을 확인하고, 두 번째와 세 번째는 각각 Publisher와 Subscriber를 포함한 토픽 구성을 확인하였다. 이후 마지막으로 앞선 세 단계를 모두 동시에 포함한 토픽을 확인하였다.
